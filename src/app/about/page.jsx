...
export default function About() {
  return (
    <div className="relative min-h-[85vh] flex items-center justify-center px-4 py-12 overflow-hidden text-center">
      ...
      <div className="bg-white/80 backdrop-blur-xl p-8 sm:p-12 rounded-3xl border border-slate-200/80 shadow-xl shadow-rose-950/5 w-full max-w-2xl text-slate-800 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2 text-left">
          <div className="p-3.5 bg-slate-50 border border-slate-200/60 rounded-2xl flex items-center gap-3">
            <div className="p-2 rounded-xl bg-rose-50 text-rose-600">
              <BookOpen className="w-4 h-4" />
            </div>
            <div>
              <p className="text-xs font-bold text-slate-800">Rich Publishing</p>
              <p className="text-[11px] text-slate-500">Image & Title stories</p>
            </div>
          </div>
          ...
          <div className="p-3.5 bg-slate-50 border border-slate-200/60 rounded-2xl flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-slate-800">Modern Stack</p>
              <p className="text-[11px] text-slate-500">Next.js & NextAuth</p>
            </div>
          </div>
        </div>
