        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          ...
          <Link href="/public-feed" className="group flex items-center gap-2.5 transition-transform duration-200 hover:scale-[1.02]">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-extrabold tracking-tight bg-gradient-to-r from-slate-900 via-rose-950 to-rose-700 dark:from-white dark:via-rose-200 dark:to-rose-400 bg-clip-text text-transparent">
                Takusa
              </span>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all cursor-pointer active:scale-90"
            ...
            <button
              className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-slate-900 dark:bg-rose-600 hover:bg-rose-600 dark:hover:bg-rose-700 text-white rounded-xl text-sm font-semibold shadow-sm transition-all duration-200 cursor-pointer active:scale-95"
              onClick={() => {
