...
export default function CommentSection({ postId }) {
  ...
  if (loading) {
    return (
      <div className="mt-5 pt-4 border-t border-slate-100 animate-pulse space-y-3">
        <div className="flex items-center gap-3 bg-slate-100/70 p-2.5 rounded-2xl">
        ...
        <div className="space-y-2 pt-2">
          ...
          <div className="h-10 bg-slate-100 rounded-2xl w-4/5" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="mt-5 pt-4 border-t border-slate-100">
      {/* 🔹 Comment input box */}
      <div className="flex items-center gap-2.5 mb-4 p-1.5 pl-3 bg-slate-50 border border-slate-200/80 rounded-2xl focus-within:ring-2 focus-within:ring-rose-500/20 focus-within:border-rose-500 focus-within:bg-white transition-all shadow-xs">
        ...
        />
        <button
          className="bg-slate-900 hover:bg-rose-600 text-white text-xs px-3.5 py-2 rounded-xl font-bold transition-all duration-200 disabled:opacity-50 flex items-center gap-1.5 cursor-pointer shrink-0"
